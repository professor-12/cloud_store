...
const ContextMenu = ({ data }) => {
      ...
      return <div className=" absolute top-2 bg-white p-1 rounded-lg w-[80%] min-w-[200px] -right-[12px] z-[99999] shadow border border-gray-300/30">
            <ul className='*:p-1 *:px-2 *:hover:bg-accent-foreground/20 py-2 space-y-px *:bg-card '>
                  ...
                  <li className='cursor-pointer flex items-center gap-2 text-destructive'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trash-2"><path d="M3 6h18" /><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6" /><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2" /><line x1="10" x2="10" y1="11" y2="17" /><line x1="14" x2="14" y1="11" y2="17" /></svg>Move to Trash</li>
            </ul>
      </div >
}