...
const MyStorage = () => {
      ...
      return (
            <div className='p-6 py-0 max-md:px-4 h-full overflow-auto '>
                  <div className='flex py-4 place-items-center justify-between w-full gap-2 bg-background'>
                        <h1 className='text-2xl  text-card-foreground  font-semibold sticky block  top-0 tracking-wider'>My Files</h1> <Link to={"/home/create-file"}>
                  ...
                  <div className='grid mt-4 grid-cols-2 gap-2 md:gap-3 lg:grid-cols-3'>
                        {
                              data?.files?.map((file => {
                                    return (
